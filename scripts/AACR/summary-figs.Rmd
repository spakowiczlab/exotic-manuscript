...
ggplot(exo.dend$segments) +
  ...
  theme_void() +
  ggsave("../../figures/AACR/clustering_samples-by-cancer.svg", width = 10, height = 4)
...
exo.ra.phyl.fil %>%
  ...
  ggsave("../../figures/AACR/stacked-bar_microbes.svg", height = 10, width = 10)
...
immunecells.l %>%
  ...
  ggsave("../../figures/AACR/stacked-bar_immune-cells.svg", height = 10, width = 10)
```
...
immunecells.l %>%
  ...
  ggsave("../../figures/AACR/boxplot_immune-by-cancer.svg", height = 15)
```
...
immunecells.l %>%
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  ggsave("../../figures/AACR/boxplot_cd8-and-TILs.svg", width = 10)
```
