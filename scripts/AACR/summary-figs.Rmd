...
ggplot(exo.dend$segments) +
  ...
  theme_void() +
  ggsave("../../figures/AACR/clustering_samples-by-cancer.pdf", width = 10, height = 4)
...
immunecells.l %>%
  ...
  ggsave("../../figures/AACR/stacked-bar_immune-cells.pdf", height = 10, width = 10)
```
...
immunecells.l %>%
  ...
  ggsave("../../figures/AACR/boxplot_immune-by-cancer.pdf", height = 15)
```
...
immunecells.l %>%
  ...
  theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
  ggsave("../../figures/AACR/boxplot_cd8-and-TILs.pdf", width = 10)
```
