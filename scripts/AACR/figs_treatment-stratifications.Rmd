...
io.form <- as.formula(paste0("Surv(days, vitalstatus) ~ ", paste(chosenvars.io, collapse = " + ")))
...
chemo.form <- as.formula(paste0("Surv(days, vitalstatus) ~ ", paste(chosenvars.chemo, collapse = " + ")))
