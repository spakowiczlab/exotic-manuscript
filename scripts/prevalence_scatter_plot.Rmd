...
+ We only want to look at taxon that appear in multiple studies (a minimum of 3 times).
+ Below, we join all our data frames together. Then we filter for taxon that appeared in more than 2 studies.
