...
saveRDS(res.df, "/fs/ess/PAS1695/projects/exotic/data/mic-genes_sigsum_regressions.RDS")
...
ggsave("~/Documents/repos/exoticpaper/analysis/figures/mosaic_reg-mic-gene.pdf",
       height = 3, width = 4)
